...
# Curated keyword-theme heatmap, demoted to a supplement now that Fig 3D uses the
# data-driven clusters; kept for comparison.
save_supp(fig5, "FigS11_curated_mechanism_heatmap.png", width = 11, height = 6)
fig5
```
...
fig3d <- ggplot(sm, aes(Treatment, cluster, fill = n)) +
  geom_tile(colour = "white", linewidth = 0.6) +
  geom_text(aes(label = n), size = 3.4, colour = "grey15") +
  scale_fill_gradient(low = "grey92", high = "#0072B2", name = "enriched\nGO terms") +
...
## Table S — All data-driven GO clusters

```{r tableS-go-clusters}
knitr::kable(go_clusters_full,
             caption = "Table S. Data-driven GO clusters (all terms; stress flag and per-stressor enrichment). Stress-relevant clusters are shown in Fig 3D.")
```
