...
# Singleton loci — single-block locus set
gostres.sing <- gost(
  query         = list(
...
# --- Singleton loci (single-block only) ---
...
```{r}
# Singleton loci: single-block only; may return NULL if too few annotated genes
