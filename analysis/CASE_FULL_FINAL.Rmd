...
# ppsig3.FDR01 feeds both Tier D and the cross-dataset tier.
# The 2-block filter (multi_sig.01) has been dropped as redundant with multi_sig:
# any locus at q < 0.01 in 2+ blocks is already captured at q < 0.05 in 2+ blocks.
alpha  <- 0.01
alpha2 <- 0.10
